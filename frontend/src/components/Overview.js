    ...
    return (
        <section>
            <div className="container-heading">
                <h1 className="heading-title secondary">What is Data Science?</h1>
                <p className="heading-subtitle-secondary">
            ...
            <div className="container-body">
                <div className="container-subheading">
                    <h2 className="subheading-title center">Skills Learned in Data Science Course</h2>
                    <p className="subheading-subtitle-primary"> Based on our analysis of data science related courses in Top 3 Universities in Singapore, we managed to get distribution of topics that are commonly learned in data science courses.
                    </p>
                </div>
                ...
                <div className="overview-dropdown dropdown center">
                    <form>
