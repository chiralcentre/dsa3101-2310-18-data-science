    ...
    return (  
        <div className="university">
            ...
            <div className='button-course-container'>
                <a href='https://www.stat.nus.edu.sg/prospective-students/undergraduate-programme/data-science-and-analytics/'><button className='button-course'>
                ...
                <a href='https://www.math.nus.edu.sg/ug/majmin/primajors/qf/'><button className='button-course'>
                ...
                <a href='https://www.stat.nus.edu.sg/'><button className='button-course'>
                ...
                <a href='https://www.comp.nus.edu.sg/programmes/ug/ba/curr/'><button className='button-course'>
